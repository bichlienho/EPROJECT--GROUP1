...
import Products_samsung from '../json/Products4.json'
function Products4() {
    return (
        <div>
            ...
            <div class="banner_section slide_wrap shop_banner_slider staggered-animation-wrap">
                <div id="carouselExampleControls" class="carousel slide carousel-fade light_arrow" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active background_bg" style={{ backgroundImage: "url('assets/images/banner/banner 28.jpg')" }}>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-8 col-sm-9 col-10">
                                            <div class="banner_content2">
                                                ...
                                                <h2 class="staggered-animation" data-animation="fadeInDown" data-animation-delay="0.3s">Samsung</h2>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-8 col-sm-9 col-10">
                                            <div class="banner_content2">
                                                ...
                                                <h2 class="staggered-animation" data-animation="fadeInDown" data-animation-delay="0.2s">Excellent   -Diverse – Strong</h2>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-8 col-sm-9 col-10">
                                            <div class="banner_content2">
                                                ...
                                                <h2 class="staggered-animation" data-animation="fadeInDown" data-animation-delay="0.3s">Stability, Trust, And Confidence.</h2>
